...
-> redo the  the graphical representation of the energies with the new parameters, but using the initial experimental energies.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODU0ODMyNjksLTE5MTE3MjM1OTcsMT
M5Mjg5MTY5M119
-->